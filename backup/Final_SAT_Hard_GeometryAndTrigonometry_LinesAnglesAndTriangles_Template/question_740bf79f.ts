...
export const generator_740bf79f = {
  metadata: {
    // id: "740bf79f",
    assessment: "SAT",
 ...
 * 
 * ORIGINAL ANALYSIS:
 * - Number ranges: [angle Z = 20°, ratio 2XY = RS (scale factor 2)]
 * - Difficulty factors: [Similar triangles, corresponding angles, scale factor distractor]
 * - Distractor patterns: [A: 2° (angle/ratio), B: 10° (half angle), D: 40° (double angle)]
 * - Constraints: [Similar triangles have congruent corresponding angles regardless of scale]
 * - Question type: [Text→Multiple Choice]
 */

// File: generators/lines-angles-and-triangles/3b225698.ts