...
export const generator_6c9444cd = {
  metadata: {
    // id: "6c9444cd",
    assessment: "SAT",
 ...
 * 
 * ORIGINAL ANALYSIS:
 * - Number ranges: [values 3-7 for dot plots, symmetric distributions around 5]
 * - Difficulty factors: [Reading dot plots, comparing medians of symmetric distributions, comparing standard deviations/spread]
 * - Distractor patterns: [Student may think standard deviations are equal due to same range/center]
 * - Constraints: [Both symmetric with same center=median, but different spreads within]
 * - Question type: [Figure→Multiple Choice Text]
 */

// File: generators/onevariable-data-distributions/d65b9a87.ts