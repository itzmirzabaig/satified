...
export const generator_810 = {
  ...
  generate: (): QuestionData => {
    ...
    // Highway speed must strictly exceed local speed; otherwise the "swapped
    // speed" distractors (L x + H y) collide with the correct system (H x + L y).
    const highwaySpeed = getRandomInt(45, 70);
    const localSpeed = getRandomInt(20, Math.min(40, highwaySpeed - 5));
